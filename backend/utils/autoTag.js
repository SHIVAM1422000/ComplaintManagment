function autoTag(message) {
  ...
  if (message.includes("issue") || message.includes("problem"))
    tags.push("issue");
  if (message.includes("question") || message.includes("query"))
    tags.push("question");

  // === PRICING ==========================================
  if (message.includes("price") || message.includes("cost"))
    tags.push("pricing");
  if (message.includes("expensive") || message.includes("cheaper"))
    tags.push("pricing-complaint");
  if (message.includes("discount") || message.includes("offer"))
    tags.push("discounts");
  if (message.includes("coupon") || message.includes("promo"))
    tags.push("promo-code");

  // === FEEDBACK =========================================
  if (message.includes("feedback")) tags.push("feedback");
  if (message.includes("complaint")) tags.push("complaint");
  if (message.includes("bad") || message.includes("poor"))
  ...
  if (message.includes("crash") || message.includes("freeze"))
    tags.push("app-crash");
